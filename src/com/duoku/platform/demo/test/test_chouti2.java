...
public class test_chouti2 extends ActivityInstrumentationTestCase2 {
	private Solo solo;
	...
	public test_chouti2() throws ClassNotFoundException {
	...
	public void test06_notice() {
		// solo.getWebElement(By.id(Constants.NOTICE_ID), 0) != null
		...
		if (solo.waitForWebElement(By.className(Constants.NOTICE), 1, 2000, false)) {
			...
			if (solo.waitForWebElement(By.className(Constants.NOTICE_ICON), 1, 2000, false)) {
				...
				if (solo.waitForWebElement(By.className("announcement_title"), 2000, false)) {
...
//	public void test07_logout() throws IOException {
//		DataCleanManager.cleanApplicationData(solo.getCurrentActivity().getApplicationContext(), "com.baidu.bdgamesdk.demo");
//		Runtime.getRuntime().exec("rm -rf /sdcard/com.baidu.plaformsdk");
//	}
}
